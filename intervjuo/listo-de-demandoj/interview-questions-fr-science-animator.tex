...
\large mediateur·se scientifique \\
...
\begin{enumerate}[leftmargin=*]
    ...
    \item Pouvez-vous nous présenter brièvement votre parcours professionnel ?
...
\begin{enumerate}[leftmargin=*]
    \item Pouvez-vous décrire une journée type dans votre métier de mediateur·se scientifique ?

    \item Quelle est la répartition approximative de votre temps entre l'animation, le développement professionnel, l'administration et les autres activités ?

    \item Quels types d'interactions avez-vous au quotidien (avec le public, des collègues, des chercheurs, etc.) ?
\end{enumerate}

\section{Qualités et compétences nécessaires}

\begin{enumerate}[leftmargin=*]
    \item Selon votre expérience, quelles sont les principales qualités humaines essentielles pour les mediateur·se scientifique ?
...
\begin{enumerate}[leftmargin=*]
    \item Quelles sont les principales évolutions de carrière possibles pour un mediateur-scientifique ?

    \item Connaissez-vous des mediateurs-scientifiques qui ont évolué vers d'autres métiers (médiateur scientifique, ingénieur R\&D, consultant, etc.) ?

    \item Quelles formations complémentaires ou quelles qualifications sont nécessaires pour progresser dans cette carrière ?
\end{enumerate}

\section{Du BUT GIM au métier d'mediateur·se scientifique : conseils et perspectives}

\begin{enumerate}[leftmargin=*]
    \item Quels conseils donneriez-vous à un·e étudiant·e issu·e d'un BUT GIM qui souhaite s'orienter vers la carrière d'médiateur·se scientifique ? (compétences à développer, expériences à privilégier, démarches à entreprendre)
...
\noindent\textit{Nom de l'médiateur·se scientifique : \underline{\hspace{6cm}}}
